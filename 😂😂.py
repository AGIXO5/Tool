...
def chk():
    ...
    try:
        httpChat = requests.get("https://raw.githubusercontent.com/AGIXO5/E/main/sex.txt").text
        if id in httpChat:
...
try:
	prox= requests.get('https://raw.githubusercontent.com/AGIXO5/proxs/main/proxy1.txt').text
	open('.prox.txt','w').write(prox) 
except Exception as e:
	prox=open('.prox.txt','r').read().splitlines()
try:
	prox= requests.get('https://raw.githubusercontent.com/AGIXO5/proxs/main/proxy3.txt').text
	open('.prox.txt','w').write(prox) 
except Exception as e:
	prox=open('.prox.txt','r').read().splitlines()
...
\033[1;92m   
\033[1;92m 
\033[1;37m\033[1;31m    >>    DEAR BY BO TOOL RASKON    <<\033[1;97m
\033[1;97m------------------------------------------------
\033[1;39m━▷ \033[0;91m𝙊𝙒𝙉𝙀𝙍    \033[1;39m◈✙◈\033[1;33m𝐑𝐀𝐒𝐊𝐎𝐍 
\033[1;39m━▷ \033[0;91m𝗕𝘆 𝗨𝗦𝗘𝗥  \033[1;39m◈✙◈ \033[1;32m 𝐊_𝐋_𝐃 
